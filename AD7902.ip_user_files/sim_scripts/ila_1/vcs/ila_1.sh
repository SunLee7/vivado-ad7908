...
#
# Generated by Vivado on Fri Apr 14 13:09:36 +0800 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../AD7902.srcs/sources_1/ip/ila_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../AD7902.srcs/sources_1/ip/ila_1/hdl/verilog" \
    "$ref_dir/../../../../AD7902.srcs/sources_1/ip/ila_1/sim/ila_1.v" \
  2>&1 | tee -a vlogan.log
